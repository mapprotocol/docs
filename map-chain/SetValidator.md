...
See example at `https://github.com/mapprotocol/atlas/blob/main/tools/makeValidator_test.go`
...
- Copy data to function `DefaultGenesisBlock`, the path is  `atlas/core/chain/genesis.go`
...
After build and start up atlas, the default validator is address you have already set up when software restart and generate first block.

## Start to mine at mainnet

Build it! go version cannot be less than 1.14.  
